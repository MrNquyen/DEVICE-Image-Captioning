...
class BaseModel(nn.Module):
    ...
    def build_model_clip(self):
        # "openai/clip-vit-large-patch14"
        self.model_clip = CLIPModel.from_pretrained(self.config["model_clip"]).to(self.device)
        self.processor_clip = CLIPProcessor.from_pretrained(self.config["model_clip"], use_fast=False)
